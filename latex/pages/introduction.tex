...
Transformers are usally used to generate Text in like Large Language Model LLMs like the the GPT \autocite{GPT2radford2019} / LaMma models \autocite{touvron2023llama}. This thesis will investigate the use of a traditional Transformer based architectures to generate texture assets. Traditional image generation is manly done throw stable diffision or throw Gan models
